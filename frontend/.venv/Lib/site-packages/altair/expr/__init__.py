...
class expr(_ExprRef, metaclass=_ExprMeta):
    ...
    def geoBounds(
        ...
        where *x0* is the minimum x-coordinate, *y0* is the minimum y-coordinate, *x1* is the
        maximum x-coordinate, and *y1* is the maximum y-coordinate. If the ``projection`` argument
