...
class TestStrUnicodeSuperSubscripts:
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ...
        (arange(12), ("0.0 + 1.0�x + 2.0�x� + 3.0�x� + 4.0�x4 + 5.0�x5 + "
                      "6.0�x6 + 7.0�x7 +\n8.0�x8 + 9.0�x? + 10.0�x�� + "
                      "11.0�x��")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0�T1(x) + 3.0�T2(x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0�T1(x) + 3.0�T2(x) - 1.0�T3(x)"),
        (arange(12), ("0.0 + 1.0�T1(x) + 2.0�T2(x) + 3.0�T3(x) + 4.0�T4(x) + "
                      "5.0�T5(x) +\n6.0�T6(x) + 7.0�T7(x) + 8.0�T8(x) + "
                      "9.0�T9(x) + 10.0�T10(x) + 11.0�T11(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0�P1(x) + 3.0�P2(x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0�P1(x) + 3.0�P2(x) - 1.0�P3(x)"),
        (arange(12), ("0.0 + 1.0�P1(x) + 2.0�P2(x) + 3.0�P3(x) + 4.0�P4(x) + "
                      "5.0�P5(x) +\n6.0�P6(x) + 7.0�P7(x) + 8.0�P8(x) + "
                      "9.0�P9(x) + 10.0�P10(x) + 11.0�P11(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0�H1(x) + 3.0�H2(x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0�H1(x) + 3.0�H2(x) - 1.0�H3(x)"),
        (arange(12), ("0.0 + 1.0�H1(x) + 2.0�H2(x) + 3.0�H3(x) + 4.0�H4(x) + "
                      "5.0�H5(x) +\n6.0�H6(x) + 7.0�H7(x) + 8.0�H8(x) + "
                      "9.0�H9(x) + 10.0�H10(x) + 11.0�H11(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0�He1(x) + 3.0�He2(x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0�He1(x) + 3.0�He2(x) - 1.0�He3(x)"),
        (arange(12), ("0.0 + 1.0�He1(x) + 2.0�He2(x) + 3.0�He3(x) + "
                      "4.0�He4(x) + 5.0�He5(x) +\n6.0�He6(x) + 7.0�He7(x) + "
                      "8.0�He8(x) + 9.0�He9(x) + 10.0�He10(x) +\n"
                      "11.0�He11(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0�L1(x) + 3.0�L2(x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0�L1(x) + 3.0�L2(x) - 1.0�L3(x)"),
        (arange(12), ("0.0 + 1.0�L1(x) + 2.0�L2(x) + 3.0�L3(x) + 4.0�L4(x) + "
                      "5.0�L5(x) +\n6.0�L6(x) + 7.0�L7(x) + 8.0�L8(x) + "
                      "9.0�L9(x) + 10.0�L10(x) + 11.0�L11(x)")),
    ))
...
def test_set_default_printoptions():
    ...
    assert_equal(str(c), "1.0 + 2.0�T1(x) + 3.0�T2(x)")
...
@pytest.mark.parametrize(('poly', 'tgt'), (
    ...
    (poly.Chebyshev, '1.0 + 2.0�T1(z) + 3.0�T2(z)'),
    (poly.Hermite, '1.0 + 2.0�H1(z) + 3.0�H2(z)'),
    (poly.HermiteE, '1.0 + 2.0�He1(z) + 3.0�He2(z)'),
    (poly.Laguerre, '1.0 + 2.0�L1(z) + 3.0�L2(z)'),
    (poly.Legendre, '1.0 + 2.0�P1(z) + 3.0�P2(z)'),
))
