...
class SelectboxMixin:
    ...
    def _selectbox(
        ...
        *,  # keyword-only arguments:
        ...
        # - None (default) â†’ "" â†’ Frontend shows contextual placeholders
        # - "" (explicit empty) â†’ " " â†’ Frontend shows empty placeholder
        # - "Custom" â†’ "Custom" â†’ Frontend shows custom placeholder
        if placeholder == "":
            placeholder = " "
